...
<div class="container-fluid">
  ...
  <!-- content -->
  <section class="tampildata">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="text-center">Jadwal Mengajar</h2>
                <hr>
            </div>
        </div>
        <div class="row">
             ...
             <div class="table-responsive">
                <div id="daftar_siswa">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $no=1;
                        $data = mysqli_query($koneksi,"SELECT StudentID,Name,Gender FROM student");
        ...
        <div class="col-sm-12 text-center">
            <button class="btn btn-primary">Tampilkan Info Mata Pelajaran</button>
        </div>
    </div>
  </section>
