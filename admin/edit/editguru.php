<?php 
   ...
   $id = $_GET['id'];
   $qe = mysqli_query($koneksi,"SELECT * FROM teacher WHERE TeacherID='$id'");
            ...
            <form action="#" id="tambahdata" method="post">
                    ...
                    <label for="gender" class="label-control">Jenis Kelamin</label>
                     <select name="jenis_kelamin" class="form-control" id="" >
                        ...
                        <option value="<?php echo $data['Gender']?>">Laki-laki</option>
                        <option value="<?php echo $data['Gender']?>">perempuan</option>
                    </select> 
...
<?php 
 if (isset($_POST['edit'])){
     ...
     $tambah = mysqli_query($koneksi,"UPDATE teacher SET Name ='$nama',Gender='$jeniskelamin' WHERE TeacherID='$id'");
     if ($tambah){
         ?>
         <script >
